// Copyright (c) 2016-2023 Khronos Group. This work is licensed under a
...
== Version/Change History
  ...
  * OpenVX 1.3.1 - kernel module registration API - Oct 2021
...
Local binary pattern is defined as: Each pixel (y,x) generate an unsigned 8-bit value
...
Each pixel (y,x) generate an unsigned 8-bit value describing the modified local
...
*Parameters*
  ...
  * `[in]` _src_ - The input image in `<<VX_DF_IMAGE_U8,VX_DF_IMAGE_U8>>` format `[*REQ-0256*]`[[REQ-0256]].
  ...
  * `[out]` _output_ - The output image in ``<<VX_DF_IMAGE_U8,VX_DF_IMAGE_U8>>` format `[*REQ-0259*]`[[REQ-0259]].
    The output image must have the same dimensions as the input image.
...
*Parameters*
  ...
  * `[in]` _context_ - The reference to the overall context.
  * `[in]` _src_ - The input image in `<<VX_DF_IMAGE_U8,VX_DF_IMAGE_U8>>` format.
...
*Parameters*
  ...
  * `[out]` _magnitude_ - The output magnitude image in `<<VX_DF_IMAGE_S16,VX_DF_IMAGE_S16>>` format `[*REQ-0274*]`[[REQ-0274]].
    The output image must have the same dimensions as the input image.
...
*Parameters*
  ...
  * `[out]` _magnitude_ - The output magnitude image in `<<VX_DF_IMAGE_S16,VX_DF_IMAGE_S16>>` format.
    The output image must have the same dimensions as the input image.
...
*Parameters*
  ...
  * `[out]` _output_x_ - [optional] The output gradient in the x direction
    ...
    The `output_x` image must have the same dimension as the input image.
  * `[out]` _output_y_ - [optional] The output gradient in the y direction
    in `<<VX_DF_IMAGE_S16,VX_DF_IMAGE_S16>>` `[*REQ-0419*]`[[REQ-0419]].
    The `output_y` image must have the same dimension as the input image.
...
*Parameters*
  ...
  * `[out]` _output_ - The output image in `<<VX_DF_IMAGE_U8,VX_DF_IMAGE_U8>>` or
    ...
    The output image must have the same dimension as the input image.
...
*Parameters*
  ...
  * `[in]` _context_ - The reference to the context `[*REQ-1997*]`[[REQ-1997]].
  * `[in]` _module_ - The short name of the module to register `[*REQ-1998*]`[[REQ-1998]].
  * `[in]` _publish_ - The entry function of the module for loading from `<<vxLoadKernels,vxLoadKernels>>` `[*REQ-1999*]`[[REQ-1999]].
  * `[in]` _unpublish_ - The entry function of the module for unloading from `<<vxUnloadKernels,vxUnloadKernels>>` `[*REQ-2000*]`[[REQ-2000]].
