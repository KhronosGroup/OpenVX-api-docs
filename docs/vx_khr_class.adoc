// Copyright (c) 2018-2026 Khronos Group. This work is licensed under a
...
// tag::refpage:vx_kernel_class_ext_e[]
// [desc='',type='enums']
==== vx_kernel_class_ext_e

// Brief text:
The enumeration lists all classifier extension kernels.

include::api/enums/vx_kernel_class_ext_e.txt[]

*Enumerator*

  * [[VX_KERNEL_SCAN_CLASSIFIER]] `VX_KERNEL_SCAN_CLASSIFIER` - The
    Classifier Extension scan kernel.
// end::refpage:vx_kernel_class_ext_e[]
...
*Enumerator*
  ...
  * [[VX_TYPE_CLASSIFIER_MODEL]] `VX_TYPE_CLASSIFIER_MODEL` - A
