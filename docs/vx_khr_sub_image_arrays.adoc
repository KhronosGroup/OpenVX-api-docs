...
NOTE: This extension is documented with the canonical name `vx_khr_sub_image_object_array` to match
the public header `VX/vx_khr_sub_image_object_array.h`. Older documents may refer to
