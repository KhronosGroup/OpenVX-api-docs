...
#   apicallp - string to use for the calling convention macro
...
class COutputGenerator(OutputGenerator):
    ...
    def genGroup(self, groupinfo, groupName):
        ...
        # Keep track of (valid) duplicates so they're not re-emitted
        duplicates = []
        ...
        for elem in groupElem.findall('enum'):
            ...
            for elem2 in groupElem.findall('enum'):
                if (elem != elem2):
                    ...
                    if (name == name2 and numVal != numVal2):
                        raise UserWarning('Duplicate enum (' + name + ') found with different values:' + strVal + ' and ' + strVal2)
                    elif (name != name2 and numVal == numVal2):
                        raise UserWarning('Two enums found with the same value: ' + name + ' = ' + name2 + ' = ' + strVal)
                    elif (name == name2 and numVal == numVal2):
                        # Duplicates where the name and value match are fine, usually will be the deliberate result of a double include
            ...
            if (emitEnum and self.isEnumRequired(elem)):
                body += "    " + name + " = " + strVal + ",\n"
