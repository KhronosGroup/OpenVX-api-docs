...
class DocOutputGenerator(OutputGenerator):
    ...
    def writeInclude(self, directory, basename, contents):
        ...
        # Asciidoc anchor
        write('// WARNING: DO NOT MODIFY! This file is automatically generated from the vx.xml registry', file=fp)
    ...
    def genStruct(self, typeinfo, typeName):
        ...
        s = 'typedef ' + typeinfo.elem.get('category') + ' _' + typeName + ' {\n'
    ...
    def genGroup(self, groupinfo, groupName):
        ...
        for elem in groupElem.findall('enum'):
            ...
            (numVal,strVal) = self.enumToValue(elem, expand)
            name = elem.get('name')
    ...
    # just integers.
    # <enum> tags which aren't transcluded by an enumerated type are
    # generated as #defines, so they go in the 'defines' directory.
    def genEnum(self, enuminfo, name):
        ...
        self.writeInclude('defines', name, s)
    #
    # Command generation
