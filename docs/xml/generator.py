...
class OutputGenerator:
    ...
    #
    # function pointers are currently being emitted in the 'basetypes'
    # directory instead of the 'funcpointers' directory due to the
    # difficulty of determining if Doxygen XML output with kind="typedef" is
    # a function pointer or a base type.
    categoryToPath = {
        'bitmask'      : 'flags',
        'enum'         : 'enums',
        'funcpointer'  : 'basetypes',
        'handle'       : 'handles',
        'define'       : 'defines',
        'basetype'     : 'basetypes',
    }
    ...
    def makeProtoName(self, name, tail):
        return self.genOpts.apicall + name + tail
    def makeTypedefName(self, name, tail):
       return '(' + self.genOpts.apicallp + 'PFN_' + name + tail + ')'
    #
